...
exports.handler = async function(event) {
  $handler = $handler ?? (new (require("/home/bro/.local/share/fnm/node-versions/v20.11.1/installation/lib/node_modules/winglang/node_modules/@winglang/sdk/lib/target-sim/api.onrequest.inflight.js")).ApiOnRequestHandlerClient({ handler: 
          ...
          require("/home/bro/codes/dev/website/target/test/main.wsim/.wing/inflight.$Closure1-1.js")({
            $counter: (function() {
  let handle = process.env.COUNTER_HANDLE_c7accff1;
  if (!handle) {
    throw new Error("Missing environment variable: COUNTER_HANDLE_c7accff1");
  }
