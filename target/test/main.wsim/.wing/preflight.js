...
class $Root extends $stdlib.std.Resource {
  constructor($scope, $id) {
      ...
      static _toInflightType() {
        return `
          require("${$helpers.normalPath(__dirname)}/inflight.$Closure3-1.js")({
            ...
            $website_url: ${$stdlib.core.liftObject(website.url)},
          })
        `;
      }
      _toInflight() {
    ...
    const website = this.node.root.new("@winglang/sdk.cloud.Website", cloud.Website, this, "cloud.Website", { path: "./client" });
    const api = this.node.root.new("@winglang/sdk.cloud.Api", cloud.Api, this, "cloud.Api", ({"cors": true, "corsOptions": ({"allowHeaders": ["*"], "allowMethods": [http.HttpMethod.POST]})}));
    (website.addJson("config.json", ({"api": api.url})));
    const counter = this.node.root.new("@winglang/sdk.cloud.Counter", cloud.Counter, this, "website-counter");
    (api.post("/hello-static", new $Closure1(this, "$Closure1")));
    const invokeAndAssert = new $Closure2(this, "$Closure2");
    this.node.root.new("@winglang/sdk.std.Test", std.Test, this, "test:renders the index page", new $Closure3(this, "$Closure3"));
    this.node.root.new("@winglang/sdk.std.Test", std.Test, this, "test:api returns the correct response", new $Closure4(this, "$Closure4"));
    this.node.root.new("@winglang/sdk.std.Test", std.Test, this, "test:api handles cors", new $Closure5(this, "$Closure5"));
  }
}
